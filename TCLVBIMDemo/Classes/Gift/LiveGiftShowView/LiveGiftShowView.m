...
- (void)setModel:(LiveGiftShowModel *)model{
    ...
    [self.iconIV sd_setImageWithURL:[NSURL URLWithString:model.user.iconUrl] placeholderImage:[UIImage imageNamed:@"default_user"]];
...
//    [self.giftIV sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.giftModel.picUrl]] placeholderImage:nil];
    ...
    self.giftIV.contentMode = UIViewContentModeScaleAspectFit;
}
...
- (UIImageView *)iconIV{
    if (!_iconIV) {
        ...
        _iconIV.image = [UIImage imageNamed:@"LiveDefaultIcon.png"];
